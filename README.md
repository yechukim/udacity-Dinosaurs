...
- 3x3 그리드 타일을 만들 건데, 인간 타일은 가장 가운데 있어야 함
- 모든 타일은 종류(종), 이미지, 사실이 쓰여있어야 한다
- 인간 타일은 종이나 사실 말고 이름 뜨면 된다.
- 그리드 나타나고 입력 폼은 사라져야 함
- 사실에 관한 거는 공룡마다 최소 6가지의 다른 사실로 랜덤으로 나타나야 하고,
  3가지는 내가 만든 메소드를 쓴 것에서 나와야함
- 타일중 하나는 피죤인데 여기에는 “All birds are considered dinosaurs.”로 떠야함
