...
- 3x3 그리드 타일을 만들 건데, 인간 타일은 가장 가운데 위치하 것 
- 모든 타일은 종류(종), 이미지, 사실을 포함해야 함
- 인간 타일은 이름만 뜨도록
- 입력 폼 클릭시 사라지고, 그리드 타일이 나타나도록
- 공룡에 대한 사실은 직접만든 3가지 메소드를 포함한 사실 6가지 중 랜덤으로 떠야함
- 피죤 타일 사실은 “All birds are considered dinosaurs.”로 떠야함
